    ...
    for tick in range(0, quantum):
        ...
        if(processpage[0] == -3):
            ...
            print("--> Process:", processing[0], "completed at time", time, ", Process start time:", processing[2][0], ", Elapsed time:", time - processing[2][0], ", Cpu time:", processing[
                  2][2], ", Pages used:", processing[2][4], ", Number of page faults:", processing[2][1], ", Page Fault Rate:", (processing[2][1] / processing[2][2]) * 100, "%")
            print("--------------------------------------------------------")
            if(len(waiting) > 0):
                toadd = waiting.pop(0)
                toadd[2][0] = time
...
if __name__ == '__main__':
    ...
    print("--> Batch Finished at time:", time, ", Page Faults:",
          pagefaults, ", Page Fault Rate:", (pagefaults / pagereads) * 100, "%")
